...
#| fig.alt: >
#|  Reconstruction of the coastlines features for 220 Ma with gray filling and no borders.
# the background map
...
#| fig.alt: >
#|  Reconstruction of the coastlines features for 220 Ma, with 3 points, one of them in Panthalassa.
plot(coast220$geometry, col="gray", border=NA)
points(posMat, col="red", pch=3)
```
...
#| fig.alt: >
#|  Reconstruction of the static polygons and coastlines features for 220 Ma, with 3 points, one of them in Panthalassa.
plot(coast220$geometry, col="gray", border=NA)
points(posMat, col="red", pch=3)
plot(pl220$geometry, col="#00555522", add=TRUE, border="#00555533")
```
...
#| fig.alt: >
#|  Reconstruction of the static polygons for 220Ma with random points from the tropics (both over land and the ocean).
...
#| fig.alt: >
#|  Reconstruction of the static polygons for 220Ma with random points from the tropics. Points over the oceans are circled.
# static polygons from 220Ma 
plot(pl220$geometry, col="#00555522", border="#00555533")
points(tropoints, pch=3)
points(tropoints[indMissing,], pch=1, cex=2, col="red")
...
#| fig.alt: >
#|   Present day landmasses shown with gray colors.
...
#| fig.alt: >
#|   Present day landmasses shown with gray color. Present-day positions of the two points that were plotted over land in the past space are visible.
plot(coast0$geometry, col="gray", border="darkgray")
points(presentPoints, col="red", pch=3)
```
...
#| fig.alt: >
#|   Overlay of reconstructions of the coastlines for 230Ma and 220Ma. Out of the three points that are given and visualized for 220Ma only the two on land are visible for the 230Ma reconstruction. 
...
#| fig.alt: >
#|   Overlay of present-day coastlines and the reconstruction of the coastlines and 220Ma. The motion of the two points over land at 220Ma are visualized with lines that connect their past positions with their present-day positions.
# redraw 220ma map
plot(coast220$geometry, col="gray", border=NA)
