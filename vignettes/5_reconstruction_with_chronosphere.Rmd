...
<a href="https://chronosphere.info"><img src="https://chronosphere.info/images/chronosphere/chronosphere_500.png" width=200 align="right" alt="The logo of the chronosphere project."></a>
...
pl100<- rgplates::reconstruct("static_polygons", age=100, model=mer)
```
...
#| fig.alt: >
#|  Static polygons of the Merdith et al 2021 model, shown with gray polygons (100 Ma).
...
continents100 <- rgplates::reconstruct("continents", age=100, model=mer)
coastlines100 <- rgplates::reconstruct("coastlines", age=100, model=mer)
```
...
#| fig.alt: >
#|  Overlay of the static polygons (gray), continental polygons (red) and modern coastlines (darkred) of the Merdith et al. 2021 model (100 Ma).
plot(pl100$geometry, col="gray70", border=NA)
plot(continents100$geometry, col="#bc683a", border=NA, add=TRUE)
plot(coastlines100$geometry, col="#63351c", border=NA, add=TRUE)
```
