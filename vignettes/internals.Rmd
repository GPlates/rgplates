...
- `methods::as()`: Used to convert between spatial types in `mapedge()`.
...
flowchart LR
  ...
  isShapefile-->fileFromPath
  shp_to_gpml-->fileFromPath
  ...
  reconstructGPlates-->isShapefile
  reconstructGPlates-->shp_to_gpml
  ...
  SpatRastFromDF
	...
	plot.subduction.zones-->sawteeth
	sawteeth-->trianglePoints
	sawteeth-->trianglePolygons
	sawteeth-->polygon
	sawteeth-->lines
  ...
  subgraph plots.R
	...
	plot.subduction.zones:::ui
	sawteeth:::ui

	end 
	
	trianglePoints-->xspline

  subgraph plot_utils.R

	trianglePolygons-->pathDists
	trianglePoints-->regularize
	regularize-->pathDists
	regularize-->getEquidistant
