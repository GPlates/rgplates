...
devtools::install_github("adamkocsis/rgplates")
```
...
```{r stable, eval=FALSE}
install.packages(
	"https://zenodo.org/record/10614722/files/rgplates_0.4.0.tar.gz?download=1", 
...
```{r gitDev, eval=FALSE}
devtools::install_github("adamkocsis/rgplates@devel")
```
