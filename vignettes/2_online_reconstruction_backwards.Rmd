...
#| fig.alt: >
#|   Static polygons of the MERDITH2021 model in the present day.
plot(pl0$geometry)
```
...
#| fig.alt: >
#|   Static polygons of the MERDITH2021 model reconstructed for 100ma.
plot(pl100$geometry)
```
...
#| fig.alt: >
#|   The coastlines feature collection reconstructed for 100ma.
plot(c100$geometry)
```
...
#| fig.alt: >
#|   The coastlines feature collection reconstructed for 100ma, with gray filling and no borders..
...
#| fig.alt: >
#|   The static polygons and the coastlines feature collection reconstructed for 100ma, with gray filling and no borders..
plot(pl100$geometry, col="gray", border=NA)
...
#| fig.alt: >
#|   The position of London on a plot of the modern coastlines.
plot(c0$geometry)
...
#| fig.alt: >
#|  The position of London on static polygon reconstruction for 100ma (gray filling). 
plot(pl100$geometry, col="gray", border=NA)
...
#| fig.alt: >
#|  The positions of multiple cities on the coastline reconstruction for 100ma (gray filling). 
# the background map
...
#| fig.alt: >
#|  Comparision of the reconstructions of the coastlines feature collection with two tectonic models: MERDITH2021 (gray) and SETON2012 (red).
plot(c100$geometry, col="gray", border=NA)
