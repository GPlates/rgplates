...
If you are on Windows, please install the [development version (which will be v0.4.2)](https://gplates.github.io/rgplates/articles/1_installation.html#development-version) of `rgplates` if you see an error mentioning a `gplates.exe.local` file while trying to use the offline method!
