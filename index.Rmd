...
| Requirement                                   | **Online (GWS)** | **Offline (Desktop App.)** |
|-----------------------------------------------|------------------|----------------------------|
| Internet connection                           | &#9989;          | &#10060;                   |
...
- Major version update to **v0.5** introduces rasters as reconstructable features and velocities
...
Due to the assymmetry of the underlying the dependecies the two main modules of the package (**online**, with GWS - d **offline**, with the GPlates desktop application), have mismatching feature coverage. The long-term developmental goal is to make these two as symmetric in capabilities and comparable in performance as possible.
